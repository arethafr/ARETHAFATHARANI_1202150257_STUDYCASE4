package com.example.android.arethafatharani_1202150257_studycase4;
...
public class ListNama extends AppCompatActivity {
    ...
    private String[] mahasiswaArray = {
            "Aretha", "Dahlia", "Raitana", "Tri", "Handayani", "Aniditya", "Abyantara", "Nadhira", "Salsabila"
            , "Dinda", "Makarim"};
    ...
    public class AddItemToListView extends AsyncTask<Void, String, Void> {
        ...
        @Override
        protected void onPreExecute() { // method sebelum task di mulai
